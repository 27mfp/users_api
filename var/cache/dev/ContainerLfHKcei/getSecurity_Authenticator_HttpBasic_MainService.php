...
class getSecurity_Authenticator_HttpBasic_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authenticator.http_basic.main'] = new \Symfony\Component\Security\Http\Authenticator\HttpBasicAuthenticator('Secured Area', ($container->privates['security.user.provider.concrete.users_in_memory'] ?? $container->load('getSecurity_User_Provider_Concrete_UsersInMemoryService')), ($container->privates['logger'] ?? $container->getLoggerService()));
    }
}
