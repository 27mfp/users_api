...
class getSecurity_User_Provider_Concrete_UsersInMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.users_in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['api' => ['password' => $container->getEnv('BASIC_USER_PASSWORD'), 'roles' => [0 => 'ROLE_USER']], 'admin' => ['password' => $container->getEnv('BASIC_ADMIN_PASSWORD'), 'roles' => [0 => 'ROLE_ADMIN']]]);
    }
}
